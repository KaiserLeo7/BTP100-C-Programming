...
int main(void)
{
	...
	getName(&fcontact.name);

	// Call the Contact function getAddress to store the values for the Address member
	getAddress(&fcontact.address);

	// Call the Contact function getNumbers to store the values for the Numbers member
	getNumbers(&fcontact.numbers);
	...
	printf("------------\n");
	printf("First name: ");
	printf("%s\n", fcontact.name.firstName);
	printf("Middle initial(s): ");
	printf("%s\n", fcontact.name.middleInitial);
	printf("Last name: ");
	printf("%s\n\n", fcontact.name.lastName);

	printf("Address Details\n");
	printf("---------------\n");
	printf("Street number: ");
	printf("%d\n", fcontact.address.streetNumber);
	printf("Street name: ");
	printf("%s\n", fcontact.address.street);
	printf("Apartment: ");
	printf("%d\n", fcontact.address.apartmentNumber);
	printf("Postal code: ");
	printf("%s\n", fcontact.address.postalCode);
	printf("City: ");
	printf("%s\n\n", fcontact.address.city);

	printf("Phone Numbers\n");
	printf("-------------\n");
	printf("Cell phone number: ");
	printf("%s\n", fcontact.numbers.cell);
	printf("Home phone number: ");
	printf("%s\n", fcontact.numbers.home);
	printf("Business phone number: ");
	printf("%s\n\n", fcontact.numbers.business);
